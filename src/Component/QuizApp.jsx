...
const QuizApp=()=>{
    ...
    let [minutes,setMinutes]=useState("01");
   ...
   let [question,setQuestion]=useState(javaQuestions[0])   
   ...
   const submitHandler=()=>{
    ...
    var result=validateEmail(email)
     if(result===true){
          ...
          setQuestion(javaQuestions[index]);
...
const AnswerCheck=(input)=>{
  if(question.answer===input && flag===false && seconds!==0){    
      setFlag(true);
      setScore((score)=>{
        return score+1;
      })
    ...
    return(
        ...
        <pre>{JSON.stringify(seconds)}</pre>
        <pre>{JSON.stringify(question)}</pre> */}
        {
                 start===false?<>
                 
                  <div className="container mt-5 vh-100"> 
                    <div className="row w-100 h-75  d-flex justify-content-center align-content-center">
                        <div className="col-sm-4 m-auto ">
                               <div className="card shadow-lg">
                                  <div className="card-body p-4">
                                         <div className="row">
                                            <div className="col-sm-12 d-flex justify-content-center align-items-center">
                                                <img src="https://masaischool.com/img/navbar/logo.svg" className="" alt=""/>
                                            </div>
                                         </div>   
                                         ...
                                         <div class="mb-3 mt-3">
                                           ...
                                           <input type="email"
                                             class="form-control" name="email" placeholder={"enter your email "} value={email} onChange={inputEmailHandler} id="" aria-describedby="helpId" placeholder={"Please Enter Your Email Address"}/>
                 ...
                 {
                  index===javaQuestions.length?<>
                     <div className="container mt-4">
                       <div className="row">
                         <div className="col-sm-5 m-auto">
                                     <div className="row">
                                        <div className="col-sm-12 text-center p-2">
                                             <p className="display-4">Thank You</p>
                                             <p className="text-success h5"><span>Your Score : </span>{`${score} / ${javaQuestions.length}`}</p>
                                        </div>
                                     </div> 
                         </div>
                       </div>
                        ...
                        <div className="card shadow-lg">
                            <div className="card-header">
                                   <div className="row">
                                    ...
                                    <div className="row h-100 justify-content-center align-items-center">
                                      ...
                                      <p className="m-0 p-0 text-dark"> <span className="fw-bold text-dark  m-1 p-0 ">Score : </span>{`${score} / ${javaQuestions.length}`}</p>                                        
                                      </div>
                                   </div>
                                    </div>
                                    <div className="col-sm-4">
                                    ...
                                    <div className="col-sm-4 border border-primary">
                                      ...
                                      <div className="row rounded-2 p-1">
                                        <div className="col-sm-6 p-1 text-end bg-primary  text-white">
                                         {"Time :- "}
                                        </div>
                                        <div className="col-sm-6  bg-primary text-white p-1">
                            ...
                            <div className="card-body">
                                ...
                                <div className="col-sm-12 ps-3">
                                       <p className="h6 text-dark"> {"Q"+" "+index+" )  "} {question.question}</p>
                                </div>
                              </div>
                                       
                                       <div className="row p-0 m-0 ps-3 pe-3">
                                             <div className={`col-sm-12 rounded-2 p-2 mb-1 border border-1  text-capitalize  ${(seconds===0 || flag===true )?question.options[0]===question.answer? "bg-success text-white":"bg-danger text-white":"border-dark text-dark"}`} onClick={()=>AnswerCheck(question.options[0])}>
                                                  {question.options[0]}
                                             </div>
                                             <div className={`col-sm-12 rounded-2 p-2 mb-1 border border-1 text-capitalize ${(seconds===0 || flag===true )?question.options[1]===question.answer? "bg-success text-white":"bg-danger text-white":"border-dark text-dark"}`}  onClick={()=>AnswerCheck(question.options[1])}>
                                                  {question.options[1]}
                                             </div>
                                             <div className={`col-sm-12 rounded-2 p-2 mb-1 border border-1  text-capitalize ${(seconds===0 || flag===true)?question.options[2]===question.answer? "bg-success text-white":"bg-danger text-white":"border-dark text-dark"}`}  onClick={()=>AnswerCheck(question.options[2])}>
                                                  {question.options[2]}
                                             </div>
                                             <div className={`col-sm-12 rounded-2 p-2 mb-1 border border-1  text-capitalize ${(seconds===0 || flag===true)?question.options[3]===question.answer? "bg-success text-white":"bg-danger text-white":"border-dark text-dark"}`}  onClick={()=>AnswerCheck(question.options[3])}>
                                                  {question.options[3]}
                                             </div>
                                        </div>
                                        </>
                            ...
                            <div className="card-footer">
                                 <button type="button" className="btn btn-primary w-25" onClick={nextQuestion}>Next </button>
                            </div>
                        </div>
                     </div>
                      ...
                      <div className="card shadow-lg">
                        <div className="card-body">
                           <ul className="list-group">
                              <li className="list-group-item">Core Java</li>
                              <li className="list-group-item">Advance Java</li>
                              <li className="list-group-item">Spring Boot</li>
                              <li className="list-group-item">Java Interview</li>
